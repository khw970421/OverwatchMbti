...
let explain3 = [
  ...
  생각을 바로 실행합니다. <br>
  관찰력이 뛰어나고 <br> 
  현상을 있는 그대로 받아들이는 성격으로<br> 
  사소한 변화도 감지하는 <br>
  능력을 지니고 있습니다.`,
  
  `사회적인 틀과 통념에 박히는 것을 지루해하며 <br>
외부 세계에 관심이 많아 새로운 시도를 좋아한다. <br>
인생을 즐겁게 사는 것에 관심이 많다. <br>
건강한 유형은 다른 사람과 관계 형성을 잘하나, <br>
그렇지 않을 경우 지나치게 예민하고 감정적일 수도 있다` 
];
