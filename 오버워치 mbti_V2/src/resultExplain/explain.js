...
let explain3 = [
  ...
  `사람들을 이끄는 것에 타고난 기질이 있고 언변이 능숙하며 지도자 성향이 있다.<br> 자신뿐 아니라 더 나아가 살기 좋은 공동체를 만들기 위해 사람들을 동참시키고 이끄는 데에서 큰 자부심과 행복을 느낍니다.<br>`,
  `마음이 따뜻하고 조용하며, 자신이 하고있는 일이나
  알고있는 사람들에 대해서 책임감이 강하고 성실하다. <br> 
  이해심이 많은 편이고 관대하며, 자신이 추구하는 이상에 대하여 정열적인 신념을 가진다.<br>`,
];
